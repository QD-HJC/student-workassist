...
const noticeList = ref([
  { id: 1, title: '2026年暑假勤工助学岗位开始报名', createTime: '2026-07-08' },
  { id: 2, title: '关于考勤系统升级的通知', createTime: '2026-07-07' },
  { id: 3, title: '薪资发放时间调整通知', createTime: '2026-07-06' }
])
